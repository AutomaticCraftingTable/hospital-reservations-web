<script setup lang="ts">
  ...
  const email = ref("")
  const password = ref("")
  const profession = ref(specializations[0]) 
  const phone = ref("")
  ...
  try {
    await registerDoctor({
      ...
      specialization: profession.value,
      description: description.value,
    });

    router.push("/login");
  } catch (e) {
    alert("Błąd rejestracji lekarza");
  }
};
        ...
        <div class="bg-white rounded-3xl shadow-lg px-14 py-12 max-w-lg w-full">
          ...
          <div class="flex items-center gap-4 mb-8">
            ...
            <div class="flex flex-col">
              ...
              <p class="text-sm text-[#4b6a88] mt-1 uppercase tracking-[0.2em] leading-snug">
          ...
          <form class="space-y-4">
            ...
            <div class="flex gap-3">
              <input
                ...
                type="text"
                placeholder="Imię"
                class="w-1/2 rounded-full bg-[#f6f8ff] border border-[#edf1ff] px-5 py-3"
              />
              <input
                v-model="surname"
                type="text"
            ...
            <input
              v-model="description"
              type="text"
              placeholder="Opis (krótki opis lekarza)"
              class="w-full rounded-full bg-[#f6f8ff] border border-[#edf1ff] px-5 py-3"
            />
            ...
            <button
              ...
              class="w-full mt-3 rounded-full bg-[#0f6bff] text-white font-semibold py-3 shadow hover:bg-[#0057e6]"
            >
              Zarejestruj się
            </button>
          </form>
  
          <p class="mt-3 text-xs text-[#9aa6c1] text-center">
